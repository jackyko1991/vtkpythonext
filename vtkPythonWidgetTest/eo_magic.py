...
"""Example that illustrates how to ensure that all instantiated wrapped
VTK objects have an ErrorEvent handler.
...
# and here's an example showing off the error handling
a = vtk.vtkPolyDataReader()
a.SetFileName('does.not.exist')
a.Update()

b = vtk.vtkPolyDataNormals()
b.Update()
